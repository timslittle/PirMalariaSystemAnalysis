---
title: "Manuscript_Github_Pchabaudi_pir_210105"
...
supp_info_fig_3b$SorL <- cir_info$SorL[match(names(apply(supp_info_fig_3b, 1, mean)), 
                                                   cir_info$Geneid)]

head(supp_info_fig_3b)
